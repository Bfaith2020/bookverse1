...
export const AuthProvide = ({children}) => {
    ...
    const loginUser = async (email, password) => {
        try {
            ...
            if (email === "admin123@gmail.com") {
                ...
                navigate("/user-frontend"); // Replace with your default user frontend route
            }
    ...
    // Function to navigate to userfrontend
    const goToUserFrontend = () => {
        navigate("/user-frontend"); // Replace with your userfrontend route
    };
    ...
    const value = {
        ...
        signInWithGoogle,
        logout,
        goToUserFrontend // Expose the function in the context
    }
    return (
